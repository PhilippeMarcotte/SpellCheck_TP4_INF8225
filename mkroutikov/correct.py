...
# data
flags.DEFINE_string('load_model', "./training/cv/epoch011_0.1216.model", '(optional) filename of the model to load. Useful for re-starting training from a checkpoint')
